...
import com.phuong.application.model.mapper.UserMapper;
...
import com.phuong.application.model.request.LoginRequest;
import com.phuong.application.model.request.UpdateProfileRequest;
import com.phuong.application.security.CustomUserDetails;
import com.phuong.application.security.JwtTokenUtil;
import com.phuong.application.service.UserService;
...
import static com.phuong.application.config.Contant.MAX_AGE_COOKIE;
...
public class UserController {
    ...
    public ResponseEntity<UserDTO> register(@Valid @RequestBody CreateUserRequest createUserRequest, HttpServletResponse response) {
        //Create user
        User user = userService.createUser(createUserRequest);
    ...
    public ResponseEntity<String> changePassword(@Valid @RequestBody ChangePasswordRequest passwordReq) {
    ...
    public ResponseEntity<String> updateProfile(@Valid @RequestBody UpdateProfileRequest profileReq) {
        User user = ((CustomUserDetails) SecurityContextHolder.getContext().getAuthentication().getPrincipal()).getUser();

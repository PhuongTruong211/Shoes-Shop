...
import static com.phuong.application.config.Contant.SIZE_VN;
...
public class ProductController {
    ...
    public ResponseEntity<Page<Product>> getListProducts(@RequestParam(defaultValue = "", required = false) String id,
                                                         @RequestParam(defaultValue = "", required = false) String name,
                                                         @RequestParam(defaultValue = "", required = false) String category,
                                                         @RequestParam(defaultValue = "", required = false) String brand,
                                                         @RequestParam(defaultValue = "1", required = false) Integer page) {
    ...
    public ResponseEntity<String> updateProduct(@Valid @RequestBody CreateProductRequest createProductRequest, @PathVariable String id) {
    ...
    public ResponseEntity<String> deleteProduct(@RequestBody String[] ids) {

...
public class PostController {
    ...
    public ResponseEntity<Page<Post>> getListPosts(@RequestParam(defaultValue = "", required = false) String title,
    ...
    public ResponseEntity<String> updatePost(@Valid @RequestBody CreatePostRequest createPostRequest, @PathVariable long id) {
        User user = ((CustomUserDetails) (SecurityContextHolder.getContext().getAuthentication().getPrincipal())).getUser();

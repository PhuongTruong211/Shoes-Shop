...
import com.phuong.application.model.dto.OrderDetailDTO;
import com.phuong.application.model.dto.OrderInfoDTO;
...
import com.phuong.application.model.request.UpdateDetailOrder;
import com.phuong.application.model.request.UpdateStatusOrderRequest;
...
//        //Get list valid promotion
    ...
    public ResponseEntity<String> updateDetailOrder(@Valid @RequestBody UpdateDetailOrder detailOrder, @PathVariable long id) {
        User user = ((CustomUserDetails) SecurityContextHolder.getContext().getAuthentication().getPrincipal()).getUser();
    ...
    public ResponseEntity<String> updateStatusOrder(@Valid @RequestBody UpdateStatusOrderRequest updateStatusOrderRequest, @PathVariable long id) {
        User user = ((CustomUserDetails) SecurityContextHolder.getContext().getAuthentication().getPrincipal()).getUser();
    ...
    public ResponseEntity<List<OrderInfoDTO>> getListOrderByStatus(@RequestParam int status) {
        // Validate status

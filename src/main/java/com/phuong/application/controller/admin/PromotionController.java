...
import com.phuong.application.model.request.CreatePromotionRequest;
...
public class PromotionController {
    ...
    public ResponseEntity<Long> createPromotion(@Valid @RequestBody CreatePromotionRequest createPromotionRequest) {
    ...
    public ResponseEntity<String> updatePromotion(@Valid @RequestBody CreatePromotionRequest createPromotionRequest, @PathVariable long id) {
